...
CREATE TABLE HF_Meal(
    ...
    HFMealRating INTEGER,
    HFMealName TEXT
);
-- Create table for Paprike 3 meals
CREATE TABLE P3_Meal(
    P3MealID INTEGER PRIMARY KEY,
    P3MealRating INTEGER,
    P3MealName TEXT
);
...
(11, 5, 'Instant Pot Ham'),
(12, 5, 'Instant Pot Rotissserie Chicken'),
(13, 5, 'Linda Laffans Lasagna'),
(14, 5, 'Maple-Glazed Skillet Chicken Breasts with Sweet Potato Hash'),
(15, 5, 'One Pot Beans and Sausages and Greens'),
(16, 5, 'Phyllo-Wrapped Herbed Pork Tenderloin with Mushrooms'),
(17, 5, 'Pineapple-Glazed Ham'),
(18, 5, 'Quick Thai Pork Stir-Fry'),
(19, 5, 'Roasted Garlic Ratatouille'),
(20, 5, 'Sous Vide Smoked Brisket'),
(21, 5, 'Souvlaki-Style Pork Tenderloin with Mixed Vegetables'),
(22, 5, 'Spicy Ground Turkey and Green Bean Stir-Fry'),
(23, 5, 'Sweet Potato Chickpea Buddha Bowl'),
(24, 5, 'The Best Baked Pineapple Chicken Thighs'),
(25, 4, 'Easy Balsamic Grilled Vegetables with Feta'),
(26, 4, 'Miso Wanton Soup'),
(27, 4, '2 Hour Paleo Slow Cooker Beef Stew'),
(28, 5, 'Pork Carnitas'),
(29, 5, 'Beef and Broccoli Stirfry'),
(30, 2, 'Baked Cod with Panko'),
(31, 4, 'Baked Gnocchi with Bacon, Tomato and Mozzarella'),
(32, 3, 'Brats and Brussel Sprouts Bowls'),
(33, 3, 'Burrito Bowls with Chicken'),
(34, 3, 'Cauliflower Rice Stuffed Peppers'),
(35, 2, 'Chicken and Bacon Pasta with Spinach and Tomatoes in Garlic Cream Sauce'),
(36, 3, 'Chicken and Rice Oh So Nice'),
(37, 3, 'Chicken Detox Soup'),
(38, 2, 'Crockpot Sausage and Peppers'),
(39, 4, 'Garlic Chicken Stir Fry'),
(40, 4, 'Ginger Salmon'),
(41, 3, 'Grilled Salmon and Couscous Pouches'),
(42, 3, 'Healthy Cauliflower Fried Rice'),
(43, 3, 'Instant Pot Root Beer Pulled Pork'),
(44, 3, 'Instant Pot Pork Roast with Vegetables and Gravy'),
(45, 3, 'Lemon Garlic Baked Chicken Thighs'),
(46, 5, 'Lentil Soup'),
(47, 5, 'Low Carb Mushroom & Spinnach Cauliflower Rice'),
(48, 5, 'Pesto Salmon Packets'),
(49, 3, 'One Pot Creamy Lemon Goat Cheese Pasta with Chickpeas and Asparagus'),
(50, 2, 'Roasted Greek-Style Chicken and Vegetables'),
(51, 3, 'Roasted Lemon Rosemary Chicken'),
(52, 2, 'Sheet Pan Roasted Brussel Sprouts, Butternut Squash, Bacon & Red Onion'),
(53, 4, 'Slow-Cooker Pulled Pork Sliders with Spicy Slaw'),
(54, 3, 'Sous Vide New York Steak with Homemade Chimichurri'),
(55, 4, 'Sriracha Hoisin Ground Pork Bowls'),
(56, 4, 'Teriyaki Salmon with Bok Choy One Pan Dinner'),
(57, 4, 'Stuffed Flank Steak'),
(58, 2, 'Winter Vegetable Stew');
